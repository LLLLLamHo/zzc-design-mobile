        ...
        value: function initDate(time) {
            ...
            switch (mode) {
                case 'date':
                    ...
                    break;
                case 'datetime':
                    (0, _setListData.createDateTimeListData)(listData, calcMinDate, calcMaxDate, calcCurrDate, use12hour, minuteStep, langData, monthList, hourRange, hourUnit);
                    break;
                case 'time':
                    (0, _setListData.createTimeListData)(listData, calcMinDate, calcMaxDate, calcCurrDate, use12hour, minuteStep, langData, hourRange, hourUnit);
                    break;
                case 'hour':
                    (0, _setListData.createHourListData)(listData, calcMinDate, calcMaxDate, calcCurrDate, use12hour, langData, hourRange, hourUnit);
                    break;
                case 'year':
                ...
                case 'month':
                    ...
                    break;
                case 'yearAndMonth':
                    (0, _setListData.createYearAndMonthListData)(listData, calcMinDate, calcMaxDate, calcCurrDate, langData, monthList);
                    break;
            }
        ...
        value: function getCurrDate() {
            ...
            switch (mode) {
                ...
                case 'month':
                    ...
                    break;
                case 'yearAndMonth':
                    resultData.currDate = (0, _getScrollData.getModeYearAndMonthData)(this.BScrollList, this.state);
                    break;
            }
            return resultData;
        }
