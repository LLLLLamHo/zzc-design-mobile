    ...
    _createClass(Icon, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                restProps = _objectWithoutProperties(_props, ['type', 'size', 'className']);

            var cls = classnames(className, PREFIXCLS, PREFIXCLS + '-' + size, PREFIXCLS + '-' + type);
            return React__default.createElement(
                'svg',
                _extends$1({ className: cls }, restProps),
...
function getToast(type, content) {
    ...
    if (_toastElem != null) {
        ...
        var zzcToastCls = classnames(PREFIXCLS$1, _defineProperty$1({}, PREFIXCLS$1 + '-nomark', !mask), _defineProperty$1({}, PREFIXCLS$1 + '-icon', type === 'loading' || type === 'success' || type === 'error' || type === 'waring'));
        ...
        ReactDOM.render(React__default.createElement(
            ...
            React__default.createElement(
                'div',
                { className: classnames(PREFIXCLS$1 + '-notice-content') },
                React__default.createElement(
                    'div',
                    { className: classnames(PREFIXCLS$1 + '-text') },
                    (type === 'success' || type === 'error' || type === 'waring' || type === 'loading') && React__default.createElement(Icon, { type: type }),
                    React__default.createElement('div', { className: classnames(PREFIXCLS$1 + '-text-content'),
...
function addAnimationEvent() {
    _toastElem = document.querySelector('.' + PREFIXCLS$1 + '-notice-content');
    if (_toastElem) {
...
var Toast = function (_Component) {
    ...
    function Toast() {
        ...
        return _possibleConstructorReturn(this, (Toast.__proto__ || _Object$getPrototypeOf(Toast)).apply(this, arguments));
    }
...
var Button = function (_PureComponent) {
    ...
    _createClass(Button, [{
        ...
        value: function setActiveClassName(activeClassName) {
            ...
            var className = classnames((_classNames = {}, _defineProperty$1(_classNames, this.props.prefixCls + '-active-' + type, activeClassNameIsUndefined), _defineProperty$1(_classNames, this.props.prefixCls + '-active-' + activeClassName, !activeClassNameIsUndefined), _classNames));
        ...
        value: function render() {
            ...
            var btnClassNames = classnames(prefixCls, (_classNames2 = {}, _defineProperty$1(_classNames2, prefixCls + '-' + size, size), _defineProperty$1(_classNames2, prefixCls + '-full', full), _defineProperty$1(_classNames2, prefixCls + '-' + type, type), _defineProperty$1(_classNames2, prefixCls + '-inline', inline), _defineProperty$1(_classNames2, prefixCls + '-disabled', disabled), _classNames2));
            return React__default.createElement(
                TouchFeedback,
                {
