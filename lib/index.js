    ...
    _createClass(Icon, [{
        ...
        value: function render() {
            ...
            return React__default.createElement(
                ...
                React__default.createElement('use', { xlinkHref: '#' + prefixCls + '-' + type })
            );
        }
    }]);
...
function getToast(type, content) {
    ...
    if (_toastElem != null) {
        ...
        var zzcToastCls = classnames(PREFIXCLS, _defineProperty$1({}, PREFIXCLS + '-nomark', !mask), _defineProperty$1({}, PREFIXCLS + '-icon', type === 'loading' || type === 'success' || type === 'error' || type === 'waring'));
        ...
        ReactDOM.render(React__default.createElement(
            ...
            React__default.createElement(
                'div',
                { className: classnames(PREFIXCLS + '-notice-content') },
                React__default.createElement(
                    'div',
                    { className: classnames(PREFIXCLS + '-text') },
                    (type === 'success' || type === 'error' || type === 'waring' || type === 'loading') && React__default.createElement(Icon, { style: { fill: '#fff' }, size: 'lg', type: type }),
                    React__default.createElement('div', { className: classnames(PREFIXCLS + '-text-content'),
