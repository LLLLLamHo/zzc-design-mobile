    ...
    (0, _createClass3.default)(App, [{
        ...
        value: function touchEnd2(scrollIndex, itemIndex) {
            ...
            if (scrollIndex == 'province') {
                var newData = JSON.parse((0, _stringify2.default)(this.state.data2));
                ...
                for (var _i = 0; _i < cityList.length; _i++) {
                    cityList[_i].text = '\u533A' + (itemIndex + 1) + '-' + this.state.city + '-' + (_i + 1);
                    cityList[_i].dataKey = '\u533A' + (itemIndex + 1) + '-' + this.state.city + '-' + (_i + 1);
                }
                ...
                var _newData = JSON.parse((0, _stringify2.default)(this.state.data2));
                var _data = _newData[2].listData;
                for (var _i2 = 0; _i2 < _data.length; _i2++) {
                    _data[_i2].text = '\u533A' + this.state.province + '-' + (itemIndex + 1) + '-' + (_i2 + 1);
                    _data[_i2].dataKey = '\u533A' + this.state.province + '-' + (itemIndex + 1) + '-' + (_i2 + 1);
                }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_zzcDesignMobile.Picker, {
                        onTouchEnd: function onTouchEnd(scrollIndex, itemIndex) {
                            _this2.touchEnd2(scrollIndex, itemIndex);
                        },
                        onTouchStart: function onTouchStart(scrollIndex) {
                            _this2.touchStart2(scrollIndex);
                        },
