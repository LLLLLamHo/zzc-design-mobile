...
var _assign = __webpack_require__(14);
var checkPropTypes = __webpack_require__(32);
var schedule = __webpack_require__(33);
var tracking = __webpack_require__(54);
...
var _holiday = __webpack_require__(107);

var _holiday2 = _interopRequireDefault(_holiday);

var _hotel = __webpack_require__(108);
...
var App = function (_PureComponent) {
    ...
    function App(props) {
        ...
        _this.handleTestTimeRange = function (value) {
            if (!value) return;
        ...
        _this.getTimeRange = function () {
            var _this$state = _this.state,
                pickupTimeRange = _this$state.pickupTimeRange,
                returnTimeRange = _this$state.returnTimeRange;

            var left = [pickupTimeRange, 24];
            var right = [returnTimeRange, 24];
    ...
    (0, _createClass3.default)(App, [{
        key: 'calcTime',
        value: function calcTime(type, value) {
            if (!value) return;
            var start = value.start,
                end = value.end;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_zzcDesignMobile.Calendar, {
                    ...
                    dayChange: function dayChange(value) {
                        return _this2.handleTestTimeRange(value);
                    },
                    ...
                    calendarMode: 'car',
                    mode: 'day*time',
                    dateExtension: _holiday2.default,
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'p',
                                    { className: 'text' },
                                    this.state.hotel_start,
                                    ' - ',
                                    this.state.hotel_end
                                )
                            )
                        ),
                        _react2.default.createElement(_zzcDesignMobile.Calendar, {
