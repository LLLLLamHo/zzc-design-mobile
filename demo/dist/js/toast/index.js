...
var _lib = __webpack_require__(91);
...
var App = function (_Component) {
    ...
    (0, _createClass3.default)(App, [{
        ...
        value: function markInfo() {
            var toast = _lib.Toast.info('这是一个有mark的info', 2, function () {
                console.log('关闭');
            }, true);
        }
    }, {
        key: 'info',
        value: function info() {
            var toast = _lib.Toast.info('没有mark的info', 2, function () {
                console.log('关闭');
            }, false);
        }
    }, {
        ...
        value: function success() {
            var toast = _lib.Toast.success('提交成功！', 2);
        }
    }, {
        key: 'error',
        value: function error() {
            var toast = _lib.Toast.error('信息错误', 2);
        }
    }, {
        key: 'waring',
        value: function waring() {
            var toast = _lib.Toast.waring('警告，数据完不整', 2);
        }
    }, {
        key: 'loading',
        value: function loading() {
            var toast = _lib.Toast.loading('努力加载中...', 2);
        }
    }, {
        key: 'render',
...
var React = _interopDefault(__webpack_require__(14));
var ReactDOM = _interopDefault(__webpack_require__(29));
