...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.state = {
            ...
            tabs3: [{ title: 'tab 1' }, { title: 'tab 2' }, { title: 'tab 3' }, { title: 'tab 4' }, { title: 'tab 5' }, { title: 'tab 6' }, { title: 'tab 7' }],
            tabs4: [{ title: 'tab 1' }, { title: 'tab 2' }, { title: 'tab 3' }, { title: 'tab 4' }, { title: 'tab 5' }, { title: 'tab 6' }, { title: 'tab 7' }],
            tabsIndex1: 0,
            tabsIndex2: 0,
            tabsIndex3: 0,
            tabsIndex4: 0
