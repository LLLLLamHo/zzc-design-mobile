...
var App = function (_Component) {
    ...
    (0, _createClass3.default)(App, [{
        ...
        value: function maskInfo() {
            _zzcDesignMobile.Toast.info('这是一个无mask的info', 2, function () {
                console.log('关闭');
            }, false);
        }
    }, {
        ...
        value: function loadingInfo() {
            if (isClose) {
                isClose = false;
                _zzcDesignMobile.Toast.hideToast();
            } else {
                isClose = true;
                _zzcDesignMobile.Toast.info('再次点击关闭toast', 0, function () {}, false);
            }
        }
    }, {
        key: 'info',
        value: function info() {
            _zzcDesignMobile.Toast.info('这是一个普通的提示', 2, function () {
                console.log('关闭');
            });
        }
    }, {
        key: 'success',
        value: function success() {
            _zzcDesignMobile.Toast.success('提交成功！', 2);
        }
    }, {
        key: 'error',
        value: function error() {
            _zzcDesignMobile.Toast.error('信息错误', 2);
        }
    }, {
        key: 'waring',
        value: function waring() {
            _zzcDesignMobile.Toast.waring('警告，数据完不整', 2);
        }
    }, {
        key: 'loading',
        value: function loading() {
            _zzcDesignMobile.Toast.loading('努力加载中...', 20);
        }
    }, {
        key: 'render',
        value: function render() {
