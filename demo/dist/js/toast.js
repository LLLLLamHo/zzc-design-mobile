...
var App = function (_Component) {
    ...
    (0, _createClass3.default)(App, [{
        ...
        value: function maskInfo() {
            _es.Toast.info('这是一个无mask的info', 2, function () {
                console.log('关闭');
            }, false);
        }
    }, {
        ...
        value: function loadingInfo() {
            if (isClose) {
                ...
                isClose = true;
                _es.Toast.info('再次点击关闭toast', 0, function () {}, false);
            }
        }
    }, {
        key: 'info',
        value: function info() {
            _es.Toast.info('这是一个普通的提示', 2, function () {
                console.log('关闭');
            });
        }
    }, {
        ...
        value: function success() {
            _es.Toast.success('提交成功！', 2);
        }
    }, {
        key: 'error',
        value: function error() {
            _es.Toast.error('信息错误', 2);
        }
    }, {
        key: 'waring',
        value: function waring() {
            _es.Toast.waring('警告，数据完不整', 2);
        }
    }, {
        key: 'loading',
        value: function loading() {
            _es.Toast.loading('努力加载中...', 2);
        }
    }, {
        key: 'render',
