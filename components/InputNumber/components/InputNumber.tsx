...
export default class InputNumber extends PureComponent<InputNumberProps, any> {
    constructor( props ) {
        super( props );
        zzcComponentUse( 'InputNumber', '组件渲染' );
    ...
    render() {
        ...
        return (
            <div className="zds-input-number">
                <span role="button" className={classnames('zds-input-number__decrease', { 'is-disabled': isDecreaseDisabled })} onClick={this.onDecrease}>-</span>
                <span role="button" className={classnames('zds-input-number__increase', { 'is-disabled': isIncreaseDisabled })} onClick={this.onIncrease}>+</span>
                <div className="zds-input-number__input">
                    <input className="zds-input-number__input--inner" min={min} max={max} type="number" value={inputValue} readOnly />
                </div>
            </div>
        )
    }
